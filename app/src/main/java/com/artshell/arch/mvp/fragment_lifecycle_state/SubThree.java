 ...
 */
@Viewable(presenter = StatePresenter.class, layout = R.layout.fragment_state_three)
public class SubThree extends BaseAnnotatedV4Fragment<StateContract.View, StateContract.Presenter>
        implements StateContract.View {

    private static final String TAG = "SubThree";
