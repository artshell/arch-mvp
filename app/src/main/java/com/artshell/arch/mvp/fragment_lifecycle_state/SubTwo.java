 ...
 */
@Viewable(presenter = StatePresenter.class, layout = R.layout.fragment_state_two)
public class SubTwo extends BaseAnnotatedV4Fragment<StateContract.View, StateContract.Presenter>
